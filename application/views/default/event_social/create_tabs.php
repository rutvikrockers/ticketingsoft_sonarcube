    ...
    <div class="container marTB50">
        ...
        <div class="fb_event-area">
          <ul class="fb_event">
            ...
            <li><h2><span>2</span> <?php echo GO_TO_PAGE?></h2></li>
            <li>        
                <p>Please check to your facebook account that has admin access to the page you want the widget to appear</p>
                <div class="btn-common">
                   <a href="<?php echo "https://facebook.com".$tab_details['link'];?>" class="facebook_icon" target="_blank">
                   <img src="<?php echo base_url();?>images/iconFB.png" alt=" " height=" " width=" " >
                   <span><?php echo GO_TO_PAGE?></span>
                   </a>
               </div>
             </li>
            </ul>
