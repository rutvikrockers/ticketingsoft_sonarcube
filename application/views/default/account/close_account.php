...
<section>  
  <div class="container marTB50">
      ...
      <?php } ?>
              ...
              <form name="change_password" class="event-title" id="change_password" method="post" action="<?php echo site_url('account/close_account');?>">
              ...
              <div class="col-sm-12 clearfix">
                  ...
                  <div class="form-group clearfix ">
                    	<div class="col-sm-12 col-xs-12">
                        	<div class="radio">
                            <label>
                              <input type="radio" name="optionsRadios" id="optionsRadios1" value="<?php echo DO_NOT_RECALL_SIGNIN_EVENTTHREE; ?>" checked="">
                          ...
                          <div class="radio">
                              <label>
                                <input type="radio" name="optionsRadios" id="optionsRadios2" value="<?php echo THE_PRODUCT_IS_TOO_DIFFICULT_TO_USE;?>">
                          ...
                          <div class="radio">
                                <label>
                                  <input type="radio" name="optionsRadios" id="optionsRadios3" value="<?php echo I_CHOSE_A_DIFFERENT_SOLUTION;?>">
                          ...
                          <div class="radio">
                                <label>
                                  <input type="radio" name="optionsRadios" id="optionsRadios4" value="<?php echo THE_PRICING_IS_TOO_HIGH;?>">
                          ...
                          <div class="radio">
                                <label>
                                  <input type="radio" name="optionsRadios" id="optionsRadios5" value="<?php echo THE_PRODUCT_LACKS_THE_NECESSARY_FEATURES;?>">
                          ...
                          <div class="radio">
                                <label>
                                  <input type="radio" name="optionsRadios" id="optionsRadios6" value="<?php echo THE_PRICING_IS_CONFUSING;?>">
                          ...
                          <div class="radio">
                                <label>
                                  <input type="radio" name="optionsRadios" id="optionsRadios7" value="<?php echo I_DO_NOT_HOST_EVENTS;?>">
                          ...
                          <div class="radio">
                                  <label>
                                    <input type="radio" name="optionsRadios" id="optionsRadios8" value="<?php echo OTHER;?>">
...
<div class="text-right">
      <input type="submit" value="<?php echo CLOSE_NOW;?>" class="btn-event2">
</div>                  
