<form>
<table id="completed_event_table" class="table table_res  contct-table">
<thead>
	<tr>
...
<tbody>
<?php if($completed_events){
                            		
			foreach ($completed_events as $aevents) {
				...
				<tr>
                    ...
                    <td class="H39_sm"><ul class="nav navbar-nav edit-delt text-center">
                        ...
                        <li>
                        <a href="" data-toggle="tooltip" data-placement="bottom" title="invite"><i class="fa fa-envelope-o" aria-hidden="true"></i></a>
                        </li>
