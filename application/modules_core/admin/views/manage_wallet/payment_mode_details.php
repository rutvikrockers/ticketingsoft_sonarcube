  ...
  <div id="page-wrapper">
            <div class="row">
                <div class=" col-xs-12 clearfix">
                    <h1><?php echo WITHDROW_DETAILS; ?>  -  <?php echo SecureShowData($site_setting['site_name']);?> </h1>
                </div>
                  ...
                  <div class="panel panel-default">
                          ...
                          <ul class="list-group">
                            ...
                            ?>
                              ...
                              <div class="ww-item33">
                                <strong><?php echo WITHDRAW_AMOUNT ?></strong> <p><?php echo strip_tags($withdraw_amount); ?></p>
                              </div>
                             </div>
                            </li>
                            <li class="list-group-item">
                                ...
                                <div class="ww-item50">                                 
                                      <ul>
                                        <li><strong><?php echo IBAN_NUMBER; ?></strong> : <?php echo SecureShowData($result['bank_account_number']); ?></li>
                                         <li><strong><?php echo ROUTING_NUMBER; ?></strong> : <?php echo SecureShowData($result['routing_number']); ?></li>
                                   ...
                                   <div class="ww-item50">                                
                                      <ul>
                                        ...
                                        <li><strong><?php echo CUSTOMER_CODE; ?></strong> : <?php echo SecureShowData($result['bank_settlement_bankcode']); ?></li>
                                      </ul>
                                  </div>
                               </div>
                            </li>                            
                  ...
                  <div class="panel panel-default">
                          ...
                          <ul class="list-group">
                            ...
                            ?>
                              ...
                              <div class="ww-item33">
                                <strong><?php echo NAME_ON_CHEQUE ?></strong> <p><?php echo $result['cheque_name']; ?></p>
                              </div>
                              <div class="ww-item33">
                                <strong><?php echo BRANCH; ?></strong> <p><?php echo $result['cheque_branch']; ?></p>
                              </div>
                            </div>
                            </li>
                             <li class="list-group-item">
