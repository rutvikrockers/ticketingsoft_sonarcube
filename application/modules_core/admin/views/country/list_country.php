    ...
    <div class="container-fluid">
            <div class="row">
               <div class="col-lg-8 col-xs-12 clearfix">
                    <h1><?php echo COUNTRIES; ?> - <?php echo SecureShowData($site_setting['site_name']);?> <?php echo ADMIN_PANEL; ?></h1>
                </div>
                <div class="col-lg-4 col-xs-12  mt20 text-right clearfix">
                	<a href="<?php echo base_url();?>admin/country/add_country" class="btn btn-primary"><?php echo NEW_COUNTRY; ?></a>
                </div>
                 <div class="page-header border clearfix"></div>
                  <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-globe"></i> <?php echo COUNTRIES;?>
                    </li>
                </ol>
            </div>
            <!-- /.row -->
									...
									?>
                                        <tr class="odd gradeX">
                                           ...
                                           <td>
                                            ...
                                            <td><?php echo anchor('admin/country/add_country/'.$id.'/',EDIT);?>
                                            <?php if(DEMO_MODE=="0"){ ?>
                                             /  <a href="<?php echo site_url('admin/country/delete_country').'/'.$id?>" onclick='return confirm("<?php echo ARE_YOU_SURE_YOU_WANT_TO_DELETE_COUNTRY;?>");'> <?php echo DELETE;?></a>
                                             <?php } ?></td>
