...
<div id="page-wrapper">
    <div class="container-fluid">
            ...
            <?php echo '<b>'.MESSAGE_SUBJECT.'</b>::'.$subject; ?>
            <div class="row">
                                  ...
                                  <table class="table table-striped table-bordered table-hover" id="sample_1">
											...
											foreach($message_conversation_list as $row)
												{
                                                    ...
                                                    if($sender_info['first_name'] !="" && $sender_info['last_name'] !="") {
                                                    ...
                                                    if($receiver_info['first_name'] !="" && $receiver_info['last_name']) {
									...
									?>
                                        <tr class="odd gradeX">
                                           ...
                                           ?>
                                           <a href="<?php echo site_url('admin/message/delete_message').'/'.$id.'/'.$c_id?>" onclick='return confirm("<?php echo ARE_YOU_SURE_YOU_WANT_TO_DELETE_MESSAGE;?>");'> <?php echo DELETE;?></a></td>
                                          <?php }?>
                                           </td>
