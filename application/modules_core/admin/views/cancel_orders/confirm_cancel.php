     ...
     <div class="container-fluid">
            <div class="row">
               <div class="col-xs-8 clearfix">
                    <h1><?php echo CONFIRM_CANCELS; ?>  - <small><?php echo SecureShowData($site_setting['site_name']);?> <?php echo ADMIN_PANEL; ?></small></h1>
                </div>
                <div class="col-lg-4 col-xs-12 clearfix mt20 text-right">
                    <a href="<?php echo base_url();?>admin/cancel_order/confirm_cancerl_report" class="btn btn-primary"><i class="fa fa-download"></i>  <?php echo EXPORT_DATA; ?></a>
                </div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-ban"></i> <?php echo ADMIN;?> <?php echo CONFIRM_CANCELS;?>
                    </li>
                </ol>
            </div>
            <!-- /.row -->
                                                ...
                                                foreach($result as $row)
                                                    {
                                                        ...
                                                        $amount = set_event_currency($total, $event_id);
