...
*/
    ...
    var handleFormWizards = function () {
        ...
        $('#form_wizard_1').bootstrapWizard({
            ...
            onNext: function (tab, navigation, index) {
                ...
                if (current >= total) {
                    ...
                    if(current==3){                        
                        $('#form_wizard_1').find('.button-overwrite').show();
                        $('#form_wizard_1').find('.button-merge').show();
                        $('#form_wizard_1').find('.button-next').hide();
        ...
        $('#form_wizard_1 .button-overwrite').click(function(){
           $("#file_type_write").val(1);
        });
        $('#form_wizard_1 .button-merge').click(function(){
           $("#file_type_write").val(2);
        });
